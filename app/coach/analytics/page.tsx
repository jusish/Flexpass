        ...
        <div className="space-y-10 pb-20 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex gap-3">
                    <Button variant="outline" className="h-11 px-6 border-white/10 bg-white/5 text-[10px] font-bold tracking-widest uppercase transition-all rounded-xl hover:bg-white/10 hover:border-white/20">
                        <Calendar className="w-4 h-4 mr-2" /> View History
                    </Button>
                    <Button className="h-11 px-8 rounded-xl text-[10px] font-bold tracking-widest uppercase silver-gradient text-black transition-all active:scale-95">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <Card key={i} className="glass-dark p-6 border-white/5 rounded-2xl satin-card relative overflow-hidden group">
                        ...
                        <p className="text-[10px] font-bold text-muted-foreground tracking-wider opacity-60 uppercase mb-1">{stat.label}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="glass-dark p-8 border-white/5 rounded-3xl satin-card flex flex-col justify-between">
                    ...
                    <Button variant="outline" className="w-full h-12 rounded-xl border-white/10 bg-white/5 text-[10px] font-bold tracking-widest uppercase hover:bg-white/10">
                        View Detailed Audit
                    </Button>
                </Card>
            </div>
