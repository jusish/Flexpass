        ...
        <div className="space-y-8 pb-20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-[11px] font-black  tracking-widest opacity-40">Create targeted offers and analyze member engagement</p>
                </div>
                <Button className="h-11 px-8 rounded-xl text-[10px] font-black  tracking-[0.2em] border-glow-silver silver-gradient text-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    ...
                    <Card key={i} className="glass-dark p-8 border-white/5 rounded-2xl satin-card relative overflow-hidden group">
                        ...
                        <p className="text-[10px] font-black text-muted-foreground  tracking-widest opacity-40 mb-2">{stat.label}</p>
                        <p className="text-3xl font-black tracking-tighter text-white mb-2 text-glow-silver">{stat.value}</p>
                        <p className="text-[10px] text-muted-foreground font-medium opacity-60  tracking-tight">{stat.desc}</p>
                    </Card>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <h3 className="text-sm font-black  tracking-widest text-glow-silver flex items-center gap-3 ml-1">
                                ...
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                    <div className="space-y-3">
                                        <div className="flex items-center gap-3">
                                            <Badge variant="outline" className={`text-[8px] font-black  tracking-widest px-2 py-0.5 ${c.status === "Active" ? "bg-emerald-500/10 text-emerald-500 border-emerald-500/20 shadow-[0_0_10px_rgba(16,185,129,0.1)]" :
                                                c.status === "Scheduled" ? "bg-amber-500/10 text-amber-500 border-amber-500/20" :
                                                    "bg-black/40 text-muted-foreground border-white/10"
                                                }`}>
                                                {c.status}
                                            </Badge>
                                            <span className="text-[9px] font-black  tracking-widest opacity-30">{c.type}</span>
                                        </div>
                                        <h4 className="text-lg font-black tracking-tight text-white group-hover:text-glow-silver transition-all">{c.title}</h4>
                                        <div className="flex items-center gap-6 text-[10px] font-black  tracking-widest opacity-40">
                                    ...
                                    <Button variant="outline" className="h-10 px-6 glass border-white/10 rounded-xl text-[9px] font-black  tracking-widest opacity-60 hover:opacity-100 transition-all group-hover:border-primary/30">
                ...
                <div className="space-y-6">
                    <h3 className="text-sm font-black  tracking-widest text-glow-silver ml-1">Templates</h3>
                    <Card className="glass-dark p-8 border-white/5 rounded-2xl satin-card relative overflow-hidden flex flex-col items-center text-center">
                        ...
                        <Button className="w-full h-12 rounded-xl text-[10px] font-black  tracking-widest silver-gradient text-black">
                            Use Blueprint
                        </Button>
                    </Card>
                    ...
                    <Card className="glass-dark p-8 border-white/5 rounded-2xl satin-card opacity-60 hover:opacity-100 transition-opacity">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h4 className="font-black text-[11px]  tracking-widest text-white">Loyalty Loop</h4>
                                <p className="text-[9px] text-muted-foreground font-bold ">Automated Reward System</p>
                            </div>
                        </div>
                        <Button variant="outline" className="w-full h-11 rounded-xl glass border-white/10 text-[9px] font-black  tracking-widest">
                            Configure
                        </Button>
                    </Card>
                </div>
