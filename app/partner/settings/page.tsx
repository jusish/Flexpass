                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            <div className="pt-8 border-t border-white/5">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div className="aspect-square border border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center group cursor-pointer hover:border-white/20 transition-all">
                                        ...
                                        <span className="text-[8px] font-black  tracking-widest opacity-30">Add Media</span>
                                    </div>
                                </div>
                            </div>
                        </Card>
                        ...
                        <div className="lg:col-span-4 space-y-8">
                            <Card className="glass-dark p-8 border-white/5 rounded-2xl satin-card text-center">
                                ...
                                <p className="text-[9px] text-muted-foreground font-medium opacity-40 mb-6 ">HQ Quality Logo / Symbol</p>
                            ...
                            <Card className="glass-dark p-8 border-white/5 rounded-2xl satin-card">
                                <div className="flex items-center justify-between mb-6">
                                    <h4 className="text-[11px] font-black  tracking-widest text-white">Sentiment Control</h4>
                                    <Badge variant="outline" className="text-[8px] font-black bg-emerald-500/5 text-emerald-500 border-emerald-500/10  tracking-widest">Public</Badge>
                                </div>
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center bg-black/40 p-4 rounded-xl border border-white/5">
                                        <div className="flex items-center gap-3">
                                            <Star className="w-4 h-4 text-emerald-500" />
                                            <span className="text-[10px] font-black  tracking-widest text-muted-foreground">Reviews</span>
                                        </div>
                                        <Switch checked />
                                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={plan.tier} className="bg-black/40 border border-white/5 rounded-2xl p-6 space-y-6 hover:border-white/10 transition-all group">
                                    ...
                                    <div>
                                        <h4 className="text-[10px] font-black  tracking-[0.2em] text-white">{plan.tier}</h4>
                                        <div className="mt-2 flex items-baseline gap-1">
                                            <span className="text-2xl font-black text-white">{plan.price},000 RWF</span>
                                            <span className="text-[10px] font-black text-muted-foreground  opacity-40">/ MO</span>
                                        </div>
                                    </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select defaultValue="monthly">
                                    ...
                                    <SelectContent className="bg-black/90 border-white/10 backdrop-blur-xl text-white">
                                        <SelectItem value="monthly" className="text-[11px] font-bold  tracking-widest">Monthly Settlement</SelectItem>
                                        <SelectItem value="quarterly" className="text-[11px] font-bold  tracking-widest">Quarterly Batch</SelectItem>
                                        <SelectItem value="immediate" className="text-[11px] font-bold  tracking-widest">On-Demand Verification</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <div className="space-y-2">
                                ...
                                <Select defaultValue="rwf">
                                    ...
                                    <SelectContent className="bg-black/90 border-white/10 backdrop-blur-xl text-white">
                                        <SelectItem value="rwf" className="text-[11px] font-bold  tracking-widest">Rwandan Franc (RWF)</SelectItem>
                                        <SelectItem value="usd" className="text-[11px] font-bold  tracking-widest">United States Dollar (USD)</SelectItem>
                                        <SelectItem value="eur" className="text-[11px] font-bold  tracking-widest">Euro (EUR)</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                        </div>
                    ...
                    <Card className="glass-dark p-8 border-white/5 rounded-2xl satin-card space-y-10 text-white">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-muted-foreground font-semibold tracking-wide opacity-50 ">Require biometric approval for terminal scans</p>
                            </div>
                            <Switch checked />
                        </div>
                        <div className="flex items-center justify-between border-t border-white/5 pt-10">
                            <div className="space-y-1">
                                ...
                                <p className="text-[10px] text-muted-foreground font-semibold tracking-wide opacity-50 ">Terminate verification sessions after 5 minutes of inactivity</p>
                            </div>
                            <Switch checked />
                        </div>
                    </Card>
