        ...
        <div className="space-y-10 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-[11px] font-semibold opacity-50 uppercase tracking-widest mt-1">Service Modules & Terminal Performance</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                    ...
                    <Card key={i} className="glass-dark p-8 border-white/5 rounded-2xl satin-card relative overflow-hidden group">
                        ...
                        <p className="text-[9px] font-bold text-muted-foreground tracking-widest opacity-40 mb-1 uppercase text-glow-silver">{stat.label}</p>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-black tracking-tighter text-white uppercase">Operational Modules</h2>
                </div>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="border-white/5 hover:bg-transparent bg-white/2">
                                <TableHead className="text-[9px] font-black tracking-widest text-muted-foreground h-16 pl-10 uppercase">Activity Module</TableHead>
                                <TableHead className="text-[9px] font-black tracking-widest text-muted-foreground h-16 uppercase">Operational Status</TableHead>
                                <TableHead className="text-[9px] font-black tracking-widest text-muted-foreground h-16 text-center uppercase">Daily Load</TableHead>
                                <TableHead className="text-[9px] font-black tracking-widest text-muted-foreground h-16 text-right uppercase">Module Yield</TableHead>
                                ...
                                <TableRow key={i} className="border-white/5 hover:bg-white/5 transition-all group">
                                    <TableCell className="pl-10 py-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h4 className="text-[11px] font-black text-white uppercase tracking-widest">{activity.name}</h4>
                                                <p className="text-[9px] text-muted-foreground font-black opacity-30 tracking-widest uppercase">MUID: {activity.id}</p>
                                            </div>
                                        </div>
                                    </TableCell>
                                    <TableCell>
                                    ...
                                    <TableCell className="text-center">
                                        ...
                                        <p className="text-[8px] font-black text-muted-foreground opacity-30 tracking-widest uppercase">Sessions / Day</p>
                                    </TableCell>
                ...
                <DialogContent className="max-w-xl bg-black/95 border-white/10 backdrop-blur-3xl rounded-3xl satin-card sm:p-10">
                    ...
                    <div className="py-8 space-y-6">
                        <div className="space-y-3">
                            <Label className="text-[10px] font-black tracking-widest text-muted-foreground opacity-40 uppercase ml-1">Universal Service Node</Label>
                            <Select>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <Label className="text-[10px] font-black tracking-widest text-muted-foreground opacity-40 uppercase ml-1">Projected Daily Cap</Label>
                            ...
                            <div className="space-y-3">
                                <Label className="text-[10px] font-black tracking-widest text-muted-foreground opacity-40 uppercase ml-1">Module Pricing Level</Label>
                                <Select defaultValue="standard">
                                    ...
                                    <SelectContent className="bg-black/95 border-white/10 backdrop-blur-3xl rounded-2xl">
                                        <SelectItem value="standard" className="rounded-xl text-[10px] font-bold uppercase">Standard Rate</SelectItem>
                                        <SelectItem value="premium" className="rounded-xl text-[10px] font-bold uppercase">Premium Surcharge</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                        </div>
                    ...
                    <DialogFooter className="gap-3 sm:gap-0 pt-4">
                        <Button variant="ghost" onClick={() => setIsAddModalOpen(false)} className="h-14 flex-1 text-muted-foreground text-[10px] font-black uppercase tracking-widest border border-white/5 rounded-2xl">
                            CANCEL
                        </Button>
                        <Button onClick={() => setIsAddModalOpen(false)} className="h-14 flex-2 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] silver-gradient text-black">
                            ACTIVATE MODULE
                        </Button>
                    </DialogFooter>
                </DialogContent>
