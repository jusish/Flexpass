        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
              <Zap className="text-primary-foreground w-4 h-4" fill="currentColor" />
            </div>
            <span className="text-xl font-semibold tracking-tight">FlexPass</span>
          </div>
      ...
      <footer className="py-12 px-6 border-t border-white/5 glass">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-semibold tracking-tight">FlexPass Rwanda</span>
          </div>
