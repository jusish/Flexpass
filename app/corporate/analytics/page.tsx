                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            {[
                                ...
                                <Card key={i} className="glass-dark p-6 border-white/5 rounded-2xl satin-card group">
                                    ...
                                    <p className="text-[10px] font-bold text-muted-foreground tracking-wider mt-1 opacity-60 ">{stat.label}</p>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <Card className="glass-dark p-8 border-white/5 rounded-3xl satin-card space-y-8">
                                ...
                                <div className="h-[350px] w-full">
                                    <ChartContainer id="corporate-visits-over-time-chart" config={chartConfig} className="h-full w-full">
                            ...
                            <Card className="glass-dark p-8 border-white/5 rounded-3xl satin-card space-y-8">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Button variant="ghost" size="sm" className="h-8 rounded-lg text-[9px] font-bold  tracking-widest opacity-40 hover:opacity-100">See All</Button>
                                </div>
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between group">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className="text-[8px] font-bold  tracking-widest text-primary/60">{log.model}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                <Button className="w-full mt-auto silver-gradient text-black font-bold h-11 rounded-xl text-[10px]  tracking-widest">Download Monthly Report</Button>
                            </Card>
                        </div>
                    </TabsContent>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <Card className="glass-dark border-white/5 rounded-3xl p-8 satin-card space-y-8">
                                ...
                                <div className="h-[350px]">
                                    <ChartContainer id="corporate-department-activity-chart" config={chartConfig} className="h-full w-full">
                                ...
                                <Table>
                                    <TableHeader className="bg-white/2 cursor-default">
                                        <TableRow className="hover:bg-transparent border-white/5">
                                            <TableHead className="text-[9px] font-bold  tracking-widest text-muted-foreground h-12 pl-8">DEPT</TableHead>
                                            <TableHead className="text-[9px] font-bold  tracking-widest text-muted-foreground text-center">SESSIONS</TableHead>
                                            <TableHead className="text-[9px] font-bold  tracking-widest text-muted-foreground text-center">USAGE %</TableHead>
                                            <TableHead className="text-[9px] font-bold  tracking-widest text-muted-foreground text-right pr-8">COST (RWF)</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                        ...
                        <Card className="glass-dark border-white/5 rounded-3xl p-10 satin-card space-y-10">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                ...
                                <div className="flex gap-2">
                                    <Badge className="bg-primary/10 text-primary border-primary/10 text-[9px] font-bold ">Morning</Badge>
                                    <Badge className="bg-secondary/10 text-secondary border-secondary/10 text-[9px] font-bold ">Lunch</Badge>
                                    <Badge className="bg-white/10 text-white border-white/10 text-[9px] font-bold ">Evening</Badge>
                                </div>
                            </div>

                            <div className="h-[450px]">
                                <ChartContainer id="corporate-peak-activity-hours-chart" config={chartConfig} className="h-full w-full">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <Card className="glass-dark border-white/5 rounded-3xl p-8 satin-card space-y-8 flex flex-col">
                                ...
                                <div className="p-6 bg-primary/5 border border-primary/10 rounded-2xl">
                                    <p className="text-[10px] text-primary font-black  tracking-widest mb-1">Corporate Strategy Note</p>
